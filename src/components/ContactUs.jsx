	...
	return (
		<div>
			<div className={contactStyle["contact-form-container"]}>
				<div className={contactStyle["contact-form-img-container"]}>
					<img
						src={contactFormImg}
						className={contactStyle["contact-form-img"]}
						alt="contact-form-img"></img>
				</div>
				...
				<div className={contactStyle["input-fields-container"]}>
					...
					<form
						id="contactus-form"
						className={contactStyle["contact-form"]}
						onSubmit={handleSubmit}>
						<div>
							<input
								type="text"
								className={contactStyle["contact-form-input"]}
						...
						<div>
							<input
								type="text"
								className={`${contactStyle["contact-form-input"]} ${contactStyle["contact-form-msg"]}`}
								placeholder="Message"
						...
						<button
							type="submit"
							className={contactStyle["contactus-btn"]}>
							Contact Us
						</button>{" "}
				...
				<div className={contactStyle["contact-info"]}>
					...
					<div className={contactStyle["location-div"]}>
						<h3>Location</h3>
						<iframe
							src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d47181.50572166761!2d42.95001896306638!3d42.34584692539633!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x405c9b428415ac77%3A0x54a8c7492541cee8!2sTkibuli!5e0!3m2!1sen!2sge!4v1702663574599!5m2!1sen!2sge"
							width="333"
							height="181"
							title="Tkibuli"
							loading="lazy"></iframe>
